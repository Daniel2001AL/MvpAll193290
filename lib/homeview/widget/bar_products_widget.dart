...
import '../service/service_images.dart';
      ...
      Padding(
        ...
        child: ElevatedButton(
          style: ElevatedButton.styleFrom(
            primary: _hasBeenPressed ? Colors.white : ColorsViews.buttonColor,
          ),
          child: Text(
            'Alimento',
            style: TextStyle(
                color:
                    _hasBeenPressed ? ColorsViews.text_subtitle : Colors.white),
          ),
          onPressed: () {
            setState(
              () {
    ...
    for (int i = 1; i < optionsLenght; i++) {
      options.add(
        Padding(
          ...
          child: Text(
            listOptions[i],
            style: const TextStyle(color: ColorsViews.text_subtitle),
          ),
        ),
      );
    }
