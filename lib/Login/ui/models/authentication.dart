...
class Authenticator {
  static Future<User?> iniciarSesion({required BuildContext context}) async {
    ...
    if (objGoogleSignInAccount != null) {
      GoogleSignInAuthentication objectGoogleSignInAuthentication =
          await objGoogleSignInAccount.authentication;
      AuthCredential credential = GoogleAuthProvider.credential(
        accessToken: objectGoogleSignInAuthentication.accessToken,
        idToken: objectGoogleSignInAuthentication.idToken,
      );
      try {
